 ...
 *
 * 【Type 2: LK / 宇树旧协议】
 * 1 : 力矩/混合控制模式 (Torque / MIT) -> 发送指令 0xA1
 * 2 : 位置模式 (Position Mode)        -> 发送指令 0xA3
 * 3 : 速度模式 (Speed Mode)           -> 发送指令 0xA2
 * 其他 : 仅读取状态 (Read Only)        -> 发送指令 0x9C
 *
 * *注意*：Type 1 的 MIT 是 0，而 Type 2 的 MIT 是 1。
 * =============================================================
 */
...
public:
    ...
    std::map<std::string, int32_t> open_device_handles; 
